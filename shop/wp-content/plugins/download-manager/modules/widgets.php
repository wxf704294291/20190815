...
class wpdm_affiliate_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        echo "<div class='panel-heading' style='font-size: 10pt'>Best File & Document Management Plugin</div><div class='panel-body' style='padding-bottom:0;background:#F2F2F2;'><a href='https://www.flyobd.com/?affid={$title}'><img src='http://cdn.wpdownloadmanager.com/wp-content/uploads/images/wpdm-main-banner-v4x.png' alt='WordPress Download Manager' /></a></div>";
        echo "<div class='panel-footer' style='line-height: 30px'><a class='pull-right btn btn-sm btn-danger' href='https://www.flyobd.com/?affid={$title}'>Buy Now <i class='fa fa-angle-right'></i></a><span class='label label-success' style='font-size: 12pt;border-radius: 2px'>$45.00</span></div></div></div>";
        echo $after_widget;
    }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <em>It is your account <b>username</b> at www.flyobd.com. You will get up to 20% from each sale referred by you</em>
        </p>
    <?php
    }
