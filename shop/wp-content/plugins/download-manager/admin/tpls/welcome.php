                         ...
                         <div style="min-height: 130px;height: 130px;overflow: hidden" class="panel-body">
                             <div class="media">
                                 ...
                                 <div class="media-body">
                                     <b><a target="_blank" href="https://www.flyobd.com/download/advanced-tinymce-button/">Advanced TinyMCE button</a></b><br>
             ...
             <div class="col-md-4" >
                 <div class="panel panel-default">
                     <div style="min-height: 130px;height: 130px;overflow: hidden" class="panel-body">
                         <div class="media">
                             <a class="pull-left" href="#">
                                 <img width="100px" src="https://www.flyobd.com/wp-content/plugins/download-manager/cache/wpdm-premium-package-200x200.png" class="img-rounded">
                             </a>
                             <div class="media-body">
                                 <b><a href="https://www.flyobd.com/download/premium-package-complete-digital-store-solution/">Premium Package &ndash; Complete Digital Store Solution</a></b><br>
                 ...
                 <div class="col-md-4">
                     <div class="panel panel-default">
                         <div style="min-height: 130px;height: 130px;overflow: hidden" class="panel-body">
                             <div class="media">
                                 <a class="pull-left" href="#">
                                     <img width="100px" src="https://www.flyobd.com/wp-content/plugins/download-manager/cache//wpdm-extended-shortcode-200x200.png" class="img-rounded">
                                 </a>
                                 <div class="media-body">
                                     <b><a target="_blank" href="https://www.flyobd.com/download/wpdm-extended-short-codes/">WPDM Extended Short-codes</a></b><br>
            ...
            <div style="clear: both"></div>
             ...
             <div class="col-md-12">
                 <div class="well">
                     <div class="media">
                         <div class="pull-right">
                             <a href="https://www.flyobd.com/downloads/free-add-ons/" target="_blank" class="btn btn-success">Explore Free Add-ons <i class="fa fa-angle-double-right"></i></a>
                         </div>
                         <div class="media-body">
                             <b>Free Add-ons</b><br/>
                 ...
                 <div class="alert alert-info">
                     <a href="https://www.flyobd.com/download/verse-wordpress-theme-for-digital-shop/" target="_blank"><i class="fa fa-gift" style="margin-right: 7px"></i> Verse – Free WordPress Theme for Digital Shops, Get it now! </a>
                 </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a type="button" id="prcbtn" target="_blank" href="https://www.flyobd.com/cart/" class="btn btn-success" style="display: none" onclick="jQuery('#addonmodal').modal('hide')">Checkout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    jQuery(function(){
        ...
        jQuery('#addonmodal').on('shown.bs.modal', function (e) {
            ...
            if(jQuery(e.relatedTarget).hasClass('btn-purchase')){
                ...
                jQuery('#modalcontents').css('padding',0).css('background','#f2f2f2').html("<iframe onload=\"jQuery('.modal-footer .btn-danger').html('Continue Shopping...');jQuery('#prcbtn').show();\" style='width: 100%;padding-top: 20px; background: #f2f2f2;height: 300px;border: 0' src='https://www.flyobd.com/?addtocart="+e.relatedTarget.rel+"'></iframe>");
            }
        })
