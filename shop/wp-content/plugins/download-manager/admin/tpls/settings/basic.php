            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <em class="note"><?php printf(__('The page where you used short-code %s','download-manager'),'<code>[wpdm_login_form]</code>'); ?> &nbsp; <a target="_blank" href="https://www.flyobd.com/doc/short-codes/wpdm_login_form-user-login-form-short-code/"><i title="Read Documentation" class="fa fa-book"></i></a></em>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <em class="note"><?php printf(__('The page where you used short-code %s','download-manager'),'<code>[wpdm_reg_form]</code>'); ?> &nbsp; <a target="_blank" href="https://www.flyobd.com/doc/short-codes/wpdm_reg_form-user-registration-form-short-code/"><i title="Read Documentation" class="fa fa-book"></i></a></em>
                    </div>
                    <div class="form-group">
                        ...
                        <em class="note"><?php printf(__('The page where you used short-code %s','download-manager'),'<code>[wpdm_user_dashboard]</code>'); ?> &nbsp; <a target="_blank" href="https://www.flyobd.com/doc/short-codes/wpdm_user_dashboard-user-dashboard-short-code/"><i title="Read Documentation" class="fa fa-book"></i></a></em>
                    </div>
