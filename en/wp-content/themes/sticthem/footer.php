	...
	<div id="footer-bottom-area" class="container">
	  <div style="text-align:center;margin-bottom:24px;margin-top:24px">
	    <p>
		   seller_01  
		   skype:zhumerchant,
		   email:zhumerchant@163.com, 
		   whatsapp:+86 17512016913;
		</p>
        <p>
		   seller_02  
		   skype:STIC-LIU,
		   email:3004451851@qq.com, 
		</p>
        <p>
		   seller_03  
		   skype:flyobd_01,
		   email:3004490579@qq.com
		</p>
		<p>
		  Shenzhen STIC Technology Co.,Ltd  All rights reserved ©2012-2018
		</p>
      </div>		
	</div>
