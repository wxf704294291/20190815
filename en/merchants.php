...
if (!$smarty->is_cached('merchants.dwt')) {
    ...
    //获取合作伙伴列表
	$partner_content_sql="select title,author,author_email,description,file_url,link from fly_article where article_id between 5 and 66;";
	$partner_list=$GLOBALS['db']->getAll($partner_content_sql);
