...
<center><a href="https://www.flyobd.com/?affid=shahriar&utm_source=<?php echo isset($_SERVER['HTTP_HOST'])?$_SERVER['HTTP_HOST']:'';?>&utm_campaign=wpdashboard&utm_term=wpdashboard" target="_blank"><img style='max-width:60%;' src='<?php echo plugins_url('/download-manager/assets/images/wpdm-logo.png'); ?>' /></a></center>
</div>
<div class="w3eden">
