...
Use [Premium Package – Complete Digital Store Solution](https://www.flyobd.com/download/premium-package-wordpress-digital-store-solution/) Add-on (free) if you need to sell your digital items. The add-on has all features you will ever need to build a perfect online shop for your digital downloads:
...
*   and [much more...](https://www.flyobd.com/downloads/ecommerce-add-ons/)


= Google Drive =
Use [Google Drive Explorer](https://www.flyobd.com/download/google-drive-explorer/) add-on ( free ) to store your files in google drive and link with download manager, get 15 GB free storage space and save your server bandwidth

= OneDrive =
Use [OneDrive Explorer](https://www.flyobd.com/download/wpdm-onedrive/) add-on ( free ) to store your files in Microsoft OneDrive and link with download manager, get 15 GB free storage space and save your server bandwidth

= DropBox =
Use [DropBox Explorer](https://www.flyobd.com/download/dropbox-explorer/) add-on ( free ) to store your files in dropbox and link with download manager, get 2 GB free storage space and save your server bandwidth

= Box.com =
Use [Box.com Explorer](https://www.flyobd.com/download/box-com-explorer/) add-on ( free ) to store your files in Box.com and link with download manager, get 10 GB free storage space and save your server bandwidth


= Add-ons =
Download and Install following free add-on to add additional features as per your need

* [Advanced Tiny-Mce Button](https://www.flyobd.com/download/advanced-tinymce-button/) for editor button to generate short-codes
* [Extended Short-codes](https://www.flyobd.com/download/wpdm-extended-short-codes/) for tree view ( [wpdm_tree] ), slider ( [wpdm_slider] ) & carousel ( [wpdm_carousel] )
* [WPDM Button Templates](https://www.flyobd.com/download/wpdm-button-templates/) for pre-designed colorful button styles
* [WPDM Image Button](https://www.flyobd.com/download/wpdm-image-button/) to replace download link label with a custom designed image

= Mobile Apps =
Check download stats and get a push notification when someone downloads, install:

* [WPDM API](https://www.flyobd.com/download/wpdm-api/) - install this add-on on your site and configure API key
* [WPDM for Abdroid](https://www.flyobd.com/download/wpdm-android/) - Install the app on your android phone
* [WPDM for iOS](https://www.flyobd.com/download/wpdm-ios/) - Check download and sales stats directly from your iPhone or iPad

= Free Themes =
* [Verse - Theme For Selling Digital Products](https://www.flyobd.com/download/verse-wordpress-theme-for-digital-shop/)
* [Swift - Theme For Selling Digital Products](https://www.flyobd.com/download/swift-wordpress-theme-for-selling-digital-products/)
* [Expo - Specially Optimized for WordPress Download Manager](https://www.flyobd.com/download/expo/)
* [More Free Themes...](https://www.flyobd.com/downloads/free-themes/)

= More Themes & Add-ons =
* [Add-ons](https://www.flyobd.com/downloads/add-ons/) - 100+ add-ons
* [Themes](https://www.flyobd.com/downloads/themes/) - Themes Specially Optimized for Download Manager
