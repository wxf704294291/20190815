    ...
    class Online_Shop_Theme_Info{
        ...
        public function at_theme_info_screen() {
            ...
            if (
                ...
                echo '<a href="http://www.flyobd.com/" target="_blank" class="wp-badge epsilon-info-logo"></a>';
        ...
        public function free_pro() {
            ...
            if ( ! empty( $free_pro ) ) {
                ...
                if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
                    ...
                    echo '<td></td>';
                    echo '<td colspan="2"><a href="http://www.flyobd.com/themes/online-shop-pro/" target="_blank" class="button button-primary button-hero"> Online Shop Pro</a></td>';
                    echo '</tr>';
...
$config = array(
    ...
    'faq'      => array(
        ...
        'third' => array (
            ...
            'button_link' => esc_url( 'http://www.flyobd.com/blog/2017/01/remove-powered-by-text-on-footer/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        ...
        'forth' => array (
            ...
            'button_link' => esc_url( 'http://www.flyobd.com/blog/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
    ),
    ...
    'support_content'      => array(
        'first' => array (
            ...
            'button_link' => esc_url( 'http://www.flyobd.com/supports/forum/online-shop/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'second' => array(
        ...
        'third' => array(
            ...
            'button_link' => 'http://www.flyobd.com/themes/online-shop-pro/',
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fourth' => array(
            ...
            'button_link' => 'http://www.flyobd.com/pre-sale-question/',
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fifth' => array(
            ...
            'button_link' => 'http://www.flyobd.com/customization-request/',
            'is_button' => false,
            'is_new_tab' => true
        )
    ),
