...
$_LANG['curr//endt_os_already_receive'] ='商家已收到退换货商品';
...
$_LANG['label_supplem//endt_explain'] = '补充说明';
...
$_LANG['paym//endt_name'] = '您选择的支付方式为：';
$_LANG['paym//endt_fee'] = '支付手续费用为：';
$_LANG['paym//endt_desc'] = '支付方式描述：';
$_LANG['curr//endt_surplus'] = '您当前的可用资金为：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
...
$_LANG['select_paym//endt_pls'] = '请选择支付方式';
...
$_LANG['account_js']['paym//endt_empty'] = '请选择支付方式！';
...
$_LANG['//endter_new_password'] = '请输入您的新密码';
$_LANG['username_no_email'] = '您填写的用户名与电子邮件地址不匹配，请重新输入！';
$_LANG['fail_s//endd_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['s//endd_success'] = '重置密码的邮件已经发到您的邮箱：';
...
$_LANG['password_js']['w//endti_address_empty'] = '请输入您的注册问题！';
...
$_LANG['s//endd_message'] = '发表留言';
$_LANG['message_type'] = '留言类型';
$_LANG['message_cont//endt'] = '留言内容';
$_LANG['submit_message'] = '提交留言';
$_LANG['upload_img'] = '上传文件';
$_LANG['img_name'] = '图片名称';
$_LANG['g//enderal_message'] = '普通留言';
...
$_LANG['curr//endt_os_not_unconfirmed'] = '当前订单状态不是“未确认”。';
$_LANG['curr//endt_os_already_confirmed'] = '当前订单已经被确认，无法取消，请与店主联系。';
$_LANG['curr//endt_ss_not_cancel'] = '只有在未发货状态下才能取消，你可以与店主联系。';
$_LANG['curr//endt_ps_not_cancel'] = '只有未付款状态才能取消，要取消请联系店主。';
...
$_LANG['consignm//endt'] = '发货单';
$_LANG['shopping_money'] = '商品总价';
$_LANG['invalid_order_id'] = '订单号错误';
$_LANG['shipping'] = '配送方式';
$_LANG['paym//endt'] = '支付方式';
$_LANG['use_pack'] = '使用包装';
$_LANG['use_card'] = '使用贺卡';
$_LANG['appeal_cred//endtial'] = '申诉凭据';
...
$_LANG['error_surplus_not_//endough'] = '您的帐户余额不足！';
...
$_LANG['label_password_int//endsity'] = '密码强度';
...
$_LANG['msg_un_l//endgth'] = '用户名最长不得超过15个字符，一个汉字等于2个字符';
...
$_LANG['msg_id//endtifying_code'] = '验证码不能为空';
$_LANG['msg_id//endtifying_not_correct'] = '验证码不正确';
...
$_LANG['agreem//endt'] = "阅读并同意《<a class=\"agreem//endt\" href=\"article.php?cat_id=-1\" target=\"_blank\">服务协议</a>》";
...
$_LANG['att//endtion'] = '关注';
$_LANG['no_att//endtion'] = '取消关注';
$_LANG['del_att//endtion'] = '确认取消此商品的关注么？';
$_LANG['add_to_att//endtion'] = '确定将此商品加入关注列表么？';
$_LANG['label_need_image'] = '是否显示商品图片：';
$_LANG['need'] = '显示';
$_LANG['need_not'] = '不显示';
$_LANG['horizontal'] = '横排';
$_LANG['verticle'] = '竖排';
$_LANG['g//enderate'] = '生成代码';
...
$_LANG['passport_js']['agreem//endt'] = '<i></i>您没有接受协议';
...
$_LANG['passport_js']['msg_un_l//endgth'] = '<i></i>用户名最长不得超过15个字符，一个汉字等于2个字符';
...
$_LANG['passport_js']['msg_id//endtifying_code'] = '<i></i>验证码不能为空';
$_LANG['passport_js']['msg_id//endtifying_not_correct'] = '<i></i>验证码不正确';



/* user_clips.dwt js 语言文件 */
$_LANG['clips_js']['msg_title_empty'] = '留言标题为空';
$_LANG['clips_js']['msg_cont//endt_empty'] = '留言内容为空';
...
$_LANG['bonus_//endd_date'] = '截至使用日期';
$_LANG['bonus_status'] = '红包状态';

$_LANG['not_//start'] = '未开始';
$_LANG['overdue'] = '已过期';
$_LANG['not_use'] = '未使用';
$_LANG['had_use'] = '已使用';
...
　　４、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、积分的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecomm//endd">我推荐的会员</a></b>。
...
$_LANG['res//endd_hash_mail'] = '点此发送认证邮件';

$_LANG['query_status'] = '查询状态';

$_LANG['change_paym//endt'] = '改用其他在线支付方式';
...
$_LANG['recomm//endd_webcode'] = '网页签名代码';
$_LANG['recomm//endd_bbscode'] = '论坛签名代码';
$_LANG['im_code'] = '聊天分享';
...
$_LANG['exchange_js']['d//endy'] = '禁止兑换';
$_LANG['exchange_js']['balance'] = '您的{%s}余额不足，请重新输入';
$_LANG['exchange_d//endy'] = '该积分不允许兑换';
$_LANG['exchange_success'] = '恭喜您， 你用%s个%s兑换了%s个%s';
$_LANG['exchange_error_1'] = 'UC//endter提交积分兑换时发生错误';
...
/* 密码找回问题 */
$_LANG['passwd_questions']['fri//endd_birthday'] = '我最好朋友的生日？';
...
$_LANG['comm//endt_list'] = '评论/晒单';
$_LANG['all_comm//endt_list'] = '全部评价/晒单';
$_LANG['bonus'] = '我的红包';
...
$_LANG['increm//endt_invoice_info'] = '增值发票信息';
...
$_LANG['evid//endce_upload'] = "证据上传";
$_LANG['complaint_title_null'] = '请选择纠纷类型！';
$_LANG['complaint_cont//endt_null'] = '问题描述不能为空！';
...
$_LANG['complaint_cont//endt_notic']  = "尊敬的用户，为了更好的解决您的问题，请您在问题描述中反馈具体纠纷问题，并上传相关证据图片，避免上传外部链接等内容，以免耽误您的纠纷处理。";
$_LANG['evid//endce_upload_notic']  = "为了能够更快更好地解决问题，请您上传与卖家沟通的记录图片或者其他证明图片";
...
$_LANG['password_differ//endce'] = "两次密码不一致！";
...
$_LANG['paym//endt_coupon'] = "还款提醒";
$_LANG['baitiao_is_pay'] = " 已还款";
$_LANG['balance_insuffici//endt'] = "账户余额不足，请选择其他支付方式";
$_LANG['Ious_Prompt_one'] = "白条分期还款 第%u期 订单号：%s";
$_LANG['Ious_Prompt_two'] = "白条还款 订单号：%s";
$_LANG['Ious_Paym//endt_success'] = "恭喜您,付款成功!";
$_LANG['my_Ious'] = "我的白条";
$_LANG['pay_fail'] = "支付失败";
$_LANG['ious_pay'] = "白条支付";
...
$_LANG['Real_name_auth//endtication_Mobile_one'] = "手机号和验证手机不符";
$_LANG['Real_name_auth//endtication_Mobile_two'] = "手机号为空，请先认证手机号";
$_LANG['Real_name_auth//endtication_Mobile_three'] = "密码为空或密码不一致";
...
$_LANG['single_comm//endt'] = "晒单评论";
$_LANG['single_comm//endt_on'] = "追加评论";
...
$_LANG['P//endding_paym//endt'] = "待付款白条";
...
$_LANG['repaym//endt'] = "还款";
$_LANG['repaym//endt_record'] = "还款记录";
$_LANG['view_repaym//endt_record'] = "查看还款记录";
$_LANG['formated_order_amount'] = "订单总价";
$_LANG['rate'] = "费率";
$_LANG['Number_periods'] = "已还期数";
$_LANG['Repaym//endt_amount_now'] = "当前应还款金额";
...
$_LANG['comm//endt_captcha_code'] = "邮箱验证码";
...
$_LANG['Rec//endt_collection'] = "近期收藏";
$_LANG['cal//enddar_help'] = '帮助';
...
$_LANG['help_Prompt_Sev//end'] = "配送支付智能查询";
...
$_LANG['comm//endt_see'] = "查看评论";
$_LANG['comm//endt_again'] = "继续评论";
$_LANG['comm//endt_add'] = "添加评论";
$_LANG['Satisfaction_evaluation'] = "满意度评价";
$_LANG['No_comm//endt'] = "暂无";
$_LANG['product_desc'] = '商品描述相符';
$_LANG['Like_ata'] = "赞一个";
$_LANG['Please_rate'] = '请打分';
$_LANG['seller_fwtd'] = '卖家服务态度';
$_LANG['logistics_speed'] = '物流发货速度';
$_LANG['logistics_s//endders'] = '配送人员态度';
$_LANG['comm//endts_think'] = "感谢您的评价";
...
$_LANG['//endd_pay_time'] = "非常抱歉，已超出最后支付尾款日期";
$_LANG['pay_//endd_one'] = "请留意支付尾款时间为";
$_LANG['zhi'] = "至";
$_LANG['pay_//endd_two'] = "止， 订金支付后无法退还！";
...
$_LANG['stores_op//ending_hours']        = '营业时间';
...
$_LANG['Inconsist//endt_goods'] = "商品实物与网站不符";
$_LANG['Inconsist//endt_goods_one'] = "实际收到 商品实物与网页介绍规格参数中的内容不符";
...
$_LANG['Application_cred//endtials'] = "申请凭据";
...
$_LANG['Email_auth//endt'] = "邮箱认证";
$_LANG['email_yanzh//endg_you'] = "您验证的邮箱";
$_LANG['Email_auth//endt_desc'] = "验证后，可用于快速找回登录密码，接收账户余额变动提醒等。";
$_LANG['is_validated'] = '验证';
$_LANG['phone_auth//endt'] = "手机认证";
$_LANG['phone_auth//endt_desc'] = "您的手机已验证，若已丢失或停用，请立即更换，避免账户被盗";
$_LANG['phone_auth//endt_desc_one'] = "验证后，可用于快速找回登录密码及支付密码，接收账户余额变动提醒。";
...
$_LANG['Safety_r//endzh//endg'] = "安全认证";
$_LANG['Safety_r//endzh//endg_desc'] = "安全认证";
...
$_LANG['s//endd_verify_email'] = '发送验证邮件';
$_LANG['input_pay_password'] = '请输入支付密码';
$_LANG['s//endd_email_in'] = '已发送验证邮件至';
$_LANG['s//endd_email_desc_one'] = '请尽快登录您的邮箱在有效期内点击验证链接完成验证。';
$_LANG['s//endd_email_desc_two'] = '未收到邮件返回验证';
$_LANG['s//endd_email_desc_three'] = '（请立即完成验证，邮箱验证不通过则修改邮箱失败）';
...
$_LANG['Mailbox_Managem//endt'] = "管理邮箱";
...
$_LANG['Auth//endtication_channel'] = "认证渠道：实名认证";
...
$_LANG['Bind_curr//endt_account'] = "绑定到当前账户";
$_LANG['Bound_bonus'] = "已绑定的红包";
$_LANG['keyong'] = "可用";
$_LANG['have_be//end_exhausted'] = "已用完";
...
$_LANG['g//enderal_audi//endce'] = '全场通用';
...
$_LANG['curr//endt_funding'] = "您当前的资金为";
$_LANG['operation_log_null'] = "您当前没有操作记录";
$_LANG['Curr//endt_balance'] = "当前可提现余额";
$_LANG['Curr//endt_balance'] = "当前可提现余额";
$_LANG['Curr//endt_balance_label'] = "可提现金额";
$_LANG['r//endmingni'] = "（人民币）";
...
$_LANG['inform_cont//endt_null']           = '举报内容不能为空！';
...
$_LANG['js_languages']['comm//endts_think'] = "感谢您的评价";
$_LANG['js_languages']['comm//endt_img_number'] = "最多只能上传10张图片！";
$_LANG['js_languages']['cont//endt_not'] = '内容不能为空';
$_LANG['js_languages']['word_number'] = '麻烦填写0-500个字哦';
$_LANG['js_languages']['button_unremove'] = '确认';
$_LANG['js_languages']['comm//endts_Other'] = '您可以继续评论其它订单商品。';
...
$_LANG['js_languages']['Mailbox_s//endt'] = "邮件已发送";
...
$_LANG['js_languages']['select_paym//endt_pls'] = '请选择支付方式';
...
$_LANG['js_languages']['no_att//endtion'] = '取消关注';
...
$_LANG['Experi//endce'] = "心得";
$_LANG['Experi//endce_one'] = "屏幕大小合适么？系统用的习惯么？配件质量如何？快写下你的评价，分享给大家吧！";
$_LANG['Experi//endce_two'] = "最多输入500字";
...
$_LANG['Account_c//endter'] = "账户中心";
$_LANG['Shop_managem//endt'] = "店铺管理";
...
$_LANG['no_bonus_//endd'] = '主人，您还没有使用过红包~';
...
$_LANG['user']['comm//endt_list_0']['no_records'] = '没有可评论的订单哦~';
$_LANG['user']['comm//endt_list_1']['no_records'] = '没有待追加的晒单哦~';
$_LANG['user']['comm//endt_list_2']['no_records'] = '没有已评论的订单哦~';
...
$_LANG['malice_report_//endd']  = "冻结到期时间：";
...
$_LANG['//endd_handle_time'] = "处理时间";
$_LANG['complaint_handle_time'] = "初步审核时间";
$_LANG['handle_user'] = "操作人";
$_LANG['//endd_handle_messg'] = "处理意见";
...
$_LANG['business_lic//endse'] = '营业执照';
$_LANG['institutional_code_certificate'] = '机构代码证';
$_LANG['account_op//ending_permit'] = '机构代码证';
$_LANG['submit_apply'] = '已提交申请';
$_LANG['purchase_order'] = '完成求购单';
$_LANG['supplier_//endtry'] = '供应商入驻';
